...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-60 shrink-0 h-dvh sticky top-0 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-6 px-3">
      {/* Logo */}
