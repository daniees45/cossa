          ...
          {NAV.map(({ label, href, icon: Icon }) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  'flex min-h-11 min-w-11 flex-col items-center justify-center gap-1 px-1 py-2.5 text-[10px] font-medium leading-normal transition-colors min-[380px]:text-[11px]',
                  active
